...
public class ex1016 {
    public static void main(String[] args){
        /*Dois carros (X e Y) partem em uma mesma direção.
         O carro X sai com velocidade constante
        ...
        int km;
        int minutosParaCarroyTomarDistancia;

        System.out.print("Digite a distância em km: ");
        km = scanner.nextInt();

        minutosParaCarroyTomarDistancia = km*2;

        System.out.println(minutosParaCarroyTomarDistancia + " minutos");
